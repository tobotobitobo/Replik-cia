...
def main():
    ...
    rgb_test, mask_test = prepare_test_data("blue/CSV_1899.jpg", "blue/CSV_1899.npz")
    
    results_table = []
    models_dir = "modelsblue"
    for model_file in os.listdir(models_dir):
        ...
        input_image = create_input_image(rgb_test, mode, is_blue_grape=True)
